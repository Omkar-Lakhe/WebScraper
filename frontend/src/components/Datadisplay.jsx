        ...
        <div>
            ...
            <div className="container">
                <form onSubmit={handleSearch}>
                    <label>
                        Enter Your Query:
                        <input type="text" value={textBoxQuery} onChange={(e) => setTextBoxQuery(e.target.value)} />
                    </label>
                    <label>
                        Keyword 1:
                    ...
                    <label>
                        Exclude Word:
                        <input type="text" value={excludeWord} onChange={(e) => setExcludeWord(e.target.value)} />
                    </label>
