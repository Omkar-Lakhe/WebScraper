...
const SearchForm = () => {
    ...
    <form className="flex justify-between mb-20 bg-white p-4 shadow-lg rounded-lg" onSubmit={handleSearch}>
        ...
        <div className="flex-1">
            <select value={keyword1} onChange={(e) => setKeyword1(e.target.value)}
        ...
        <div className="flex-1">
            <select value={keyword2} onChange={(e) => setKeyword2(e.target.value)}
                className="w-full p-4 border-t border-l border-b border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
        ...
        <div className="flex-1">
            <select value={excludeWord} onChange={(e) => setExcludeWord(e.target.value)}
        ...
        <button type="submit" className="bg-indigo-500 text-white p-4 rounded-lg ml-4 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
            Search
        </button>
    </form>
                        ...
                        <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden border-separate space-y-6 border-spacing-y-2">
                            <thead className='shadow-md'> 
                                <tr className='bg-blue-100 text-black'>
                                    <th className="w-1/4 px-4 py-2 border border-gray bg-blue-100">Title</th>
                                    <th className="w-1/4 px-4 py-2 border border-gray bg-blue-100">Link</th>
                                    <th className="w-1/4 px-4 py-2 border border-gray bg-blue-100">Submission Status</th>
                                    <th className="w-1/4 px-4 py-2 border border-gray bg-blue-100">Expiry Dates</th>
                                </tr>
                            </thead>
